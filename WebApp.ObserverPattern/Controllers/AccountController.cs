...
public class AccountController : Controller
{
    ...
    public AccountController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IMediator mediator)
    {
    ...
    {
        var appUser = new AppUser { UserName = userCreate.UserName, Email = userCreate.Email };
