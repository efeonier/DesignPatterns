...
using WebApp.StrategyPattern.Repository.Concrete.MsSql;
using WebApp.StrategyPattern.Services.Abstract;
using WebApp.StrategyPattern.Services.Concrete;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddScoped<IProductRepository>(sp =>
        {
            ...
            var claim = httpContextAccessor.HttpContext?.User.Claims.FirstOrDefault(w => w.Type == SettingsModel.ClaimDatabaseType);
